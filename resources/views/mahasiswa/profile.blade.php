...
@section('content')
    ...
    <div class="container-fluid mt-5 p-5">
        <div class="row">
            <div class="col-md-4">
                <div class="card shadow-lg p-5" style="background: rgb(211, 212, 218)">
                    <img src="{{ asset('asset/img/user') . '/' . $mahasiswa->image }}" class="card-img-top shadow-sm"
                        alt="...">
                </div>
            </div>
            <div class="col-md-8">
                ...
                <div class="card shadow-lg pb-4 mt-4" style="border-left: 4px solid rgb(6, 6, 138); color:black">
                    <ul class="text-capitalize mt-3 px-5">
                        <li class="mb-3">
                            <span>NIM : {{ $mahasiswa->nomor_induk }}</span>
                        </li>
                        <li class="mb-3">Nama : {{ $mahasiswa->name }}</li>
                        <li class="mb-3">jenis kelamin : {{ $mahasiswa->gender }}</li>
                        <li class="mb-3">alamat : {{ $mahasiswa->address }}</li>
                        <li class="mb-3">program studi :
                            {{ $mahasiswa->prodi_id == null ? 'Unknown' : $mahasiswa->prodi->nama_prodi }}</li>
                        <li class="mb-3">jumlah produk :
                            <a href="#product" class="btn btn-primary btn-sm">
                                Product <span class="badge badge-light">{{ $mahasiswaProduct->count() }}</span>
                                <span class="sr-only">unread messages</span>
                            </a>
                        </li>
                        <li class="mb:3">Level User :
                            <h4 class="badge badge-primary px-3 py-2">
                                {{ $mahasiswa->level_user }}
                            </h4>
                        </li>
                    </ul>
                </div>
                <div class="row mt-3">
                    ...
                    <div class="col-md-6 my-2">
                        <button data-target="#modalBiodata" data-toggle="modal"
                            class="btn btn-info btn-block font-weight-bold" style="color: black">Update</button>
                    </div>
                </div>
            </div>
        </div>
        <div class="row mt-5">
            ...
            @foreach ($mahasiswaProduct as $product)
    ...
    <div class="modal fade" id="modalBiodata" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog modal-dialog-centered modal-md" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('mahasiswa.profile.update', $mahasiswa->nomor_induk) }}" method="post"
                    ...
                    <div class="modal-body" style="color: black">
                        <div class="form-group">
                            ...
                            <input type="number" name="nomor_induk" class="form-control" id="nim"
                                value="{{ $mahasiswa->nomor_induk }}" disabled>
                            @error('nomor_induk')
                        ...
                        <div class="form-group">
                            ...
                            <input type="radio" name="gender" id="gender" value="Laki-Laki"
                                {{ $mahasiswa->gender == 'Laki-Laki' ? 'checked' : '' }}>Laki-Laki
                            <input type="radio" name="gender" id="gender" value="Perempuan"
                                {{ $mahasiswa->gender == 'Perempuan' ? 'checked' : '' }}>Perempuan
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="address" id="address" cols="30" rows="2"
                                class="form-control">{{ $mahasiswa->address }}</textarea>
                            @error('address')
                                <div class="text-danger">
                                    <strong>
                                        <small>{{ $message }}</small>
                        ...
                        <div>
                            ...
                            <center>
                                <img src="{{ asset('asset/img/user') . '/' . $mahasiswa->image }}" alt="" height="100"
                                    width="100">
                            </center>
