    ...
    <div class="container-fluid mx-5 mt-5 pt-5">
        <div class="row">
            <div class="col-md-4 ml-5 p-5 shadow-lg rounded bg-light" style="border-left: 4px solid rgb(11, 11, 68)">
                ...
                <a href="{{ url('dosen' . '/' . $product->user->nomor_induk) }}"
                    class="btn btn-block btn-outline-primary">Back to
                    Profile</a>
            </div>
            <div class="col-md-6 shadow-lg p-3 bg-light" style=" border-left: 4px solid rgb(11, 11, 68)">
                <ul class=" text-capitalize">
                    <li class="mb-3">
                        <span>judul : {{ $product->title }}.</span>
                    </li>
                    <li class="mb-3">tipe produk :
                        <div class="badge badge-pill badge-primary text-uppercase">{{ $product->type->type }}</div>
                    </li>
                    ...
                    <li class="mb-3">Tahun Penulisan :
                        {{ $product->created_at == null ? 'Unknown' : $product->created_at->format('d F, Y') }}
                    </li>
